...
scripts/
    ...
    └── create-n8n-workflows.py  # Create + activate all 10 n8n webhook workflows via API (auto-called by setup.sh --with-n8n)
mcp-guides/
